...
Transfinite Curve {44, 45} = nxfar Using Progression 1;
Transfinite Curve {47, 48} = nxfar Using Progression 1;
...
Transfinite Curve {43} = nxmid Using Bump 1.2;
Transfinite Curve {46} = nxmid Using Bump 1.2;
...
Transfinite Curve {24, 25, 26, 27} = nyfar2 Using Progression 0.85;
//+
