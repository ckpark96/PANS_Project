...
nyfar    = 100;
//+
Transfinite Curve {26, 30, 27, 31} = nxfar Using Progression 1.09;
Transfinite Curve {34, 35} = nxfar Using Progression 1.12;
Transfinite Curve {37, 38} = nxfar Using Progression 1.08;
Transfinite Curve {40, 41} = nxfar Using Progression 1.08;

Transfinite Curve {24, 25} = nxnear Using Progression 0.93;
...
Transfinite Curve {36} = nxmid Using Bump 1.4;
Transfinite Curve {39} = nxmid Using Progression 1;
...
Transfinite Curve {9} = nyinlet2 Using Progression 0.935;
Transfinite Curve {10, 11, 12, 13} = nyinlet2 Using Bump 4;
...
Transfinite Curve {20, 21, 22, 23} = nyfar Using Progression 0.982;
//+
