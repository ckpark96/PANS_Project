...
nyfar    = 30;
//+
Transfinite Curve {26, 30, 27, 31} = nxfar Using Progression 1.07;
Transfinite Curve {34, 35} = nxfar Using Progression 1.1;
Transfinite Curve {37, 38} = nxfar Using Progression 1.06;
Transfinite Curve {40, 41} = nxfar Using Progression 1.06;

Transfinite Curve {24, 25} = nxnear Using Progression 0.95;
Transfinite Curve {28, 29} = nxnear Using Progression 0.93;
Transfinite Curve {32, 33} = nxnear Using Progression 0.9;
Transfinite Curve {16, 17} = nxnear Using Progression 0.88;

Transfinite Curve {3} = nxmid Using Progression 1;
Transfinite Curve {36, 39} = nxmid Using Progression 1;

Transfinite Curve {4, 5, 6, 7, 8} = nyinlet Using Progression 1;
Transfinite Curve {9} = nyinlet2 Using Progression 0.8;
Transfinite Curve {10, 11, 12, 13} = nyinlet2 Using Progression 1;
Transfinite Curve {1, 2} = nymid Using Progression 0.9;
Transfinite Curve {14, 15} = nymid Using Progression 1;
Transfinite Curve {18, 19} = nymid Using Progression 1;
Transfinite Curve {20, 21, 22, 23} = nyfar Using Progression 0.89;
//+
