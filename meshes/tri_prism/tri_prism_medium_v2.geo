...
nyfar    = 110;
//+
Transfinite Curve {26, 30, 27, 31} = nxfar Using Progression 1.1;
Transfinite Curve {34, 35} = nxfar Using Progression 1.2;
Transfinite Curve {37, 38} = nxfar Using Progression 1.08;
Transfinite Curve {40, 41} = nxfar Using Progression 1.08;

Transfinite Curve {24, 25} = nxnear Using Progression 0.91;
Transfinite Curve {28, 29} = nxnear Using Progression 0.91;
Transfinite Curve {32, 33} = nxnear Using Progression 0.85;
...
Transfinite Curve {39} = nxmid Using Bump 1.2;
...
Transfinite Curve {20, 21, 22, 23} = nyfar Using Progression 0.986;
//+
