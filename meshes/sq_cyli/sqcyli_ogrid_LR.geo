...
nxoutlet = 25;
// Diagonal lines inside inner square
Transfinite Curve {1,2,3,4} = ndiag Using Progression 0.85;
// Vertical lines in the middle
...
Transfinite Curve {6,9,12,15} = nxmid Using Bump 3;
// Lines outside the 'cross'
Transfinite Curve {5} = nymid Using Bump 1; // left
Transfinite Curve {10} = nymid Using Bump 1.5; // right
Transfinite Curve {11,16} = nxmid Using Bump 2; // bottom and top
// Outer vertical lines
Transfinite Curve {17,18,19,20,21,22} = nyfar Using Progression 0.95;
Transfinite Curve {23,24} = nyfar Using Progression 1.1;
// Inlet horizontal lines
