...
ynoutlet = 55;
// Transfinite lines
Transfinite Curve {9, 10, 25, 26} = yncyli Using Bump 0.13;
Transfinite Curve {17, 24, 27, 28} = xncyli Using Bump 0.12;
Transfinite Curve {15, 16, 18, 19, 20, 21, 22, 23} = xnfar Using Progression 0.843;
Transfinite Curve {5, 6, 7, 8} = yninlet Using Progression 0.832;
Transfinite Curve {11, 12, 13, 14} = ynoutlet Using Progression 1.1;
// x: 480; y: 330
...
Extrude {0, 0, 1} {
  Surface{1}; Surface{2}; Surface{3}; Surface{4}; Surface{5}; Surface{6}; Surface{7}; Surface{8}; Layers{1}; Recombine;
}
